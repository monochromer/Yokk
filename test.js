...
describe('TESTING TEAMS API', () => {
    it('CREATE new team Soshace', (done) => {
        const teamName = 'Soshace';

        supertest(app)
            .post(`/api/team/${teamName}`)
            .expect(200)
            .end((err, res) => {
                res.status.should.equal(200);
    ...
    it('CREATE new team Ecahsos', (done) => {
        const teamName = 'Ecahsos';
    ...
    it('READ non-existent team', (done) => {
    ...
    it('UPDATE Soshace team', (done) => {
        const teamName = 'Soshace';
        const requestBody = {
            teamLead: 'Nikita Bragin'
        }

        supertest(app)
            .put(`/api/team/${teamName}`)
            .send(requestBody)
            .expect(200)
            .end((err, res) => {
                res.status.should.be.equal(200);
                res.body.name.should.be.equal(teamName);
                res.body.teamLead.should.be.equal(requestBody.teamLead)
                done();
            });
    });

    it('UPDATE non-existent team', (done) => {
        const teamName = 'non-existent';
        supertest(app)
            .put(`/api/team/${teamName}`)
            .expect(500)
    ...
    it('UPDATE team not specifying team\'s name', (done) => {
        supertest(app)
            .put(`/api/team/`)
            .expect(500)
            .end((err, res) => {
    ...
    it('DELETE Soshace team', (done) => {
        supertest(app)
            .delete(`/api/team/Soshace`)
            .expect(200)
            .end((err, res) => {
                res.status.should.be.equal(200);
    ...
    it('DELETE Ecahsos team', (done) => {
        supertest(app)
            .delete(`/api/team/Ecahsos`)
            .expect(200)
            .end((err, res) => {
                res.status.should.be.equal(200);
                res.body.n.should.be.equal(1);
    ...
    it('DELETE team not specifying team\'s name', (done) => {
        supertest(app)
            .delete(`/api/team/`)
            .expect(500)
            .end((err, res) => {
    ...
    it('DELETE non-existent team', (done) => {
        const teamName = 'non-existent';
        supertest(app)
            .delete(`/api/team/${teamName}`)
            .expect(500)
            .end((err, res) => {
                res.status.should.be.equal(200);
